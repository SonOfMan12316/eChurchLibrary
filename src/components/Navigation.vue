<template>
  ...
  >
    <nav
      class="flex flex-col lg:flex-row justify-center px-6 sm:px-6 lg:px-16 xl:px-20 lg:py-8 z-10"
    >
      <div class="nav-content">
        ...
        <div class="nav-links hidden">
          <ul
            v-show="!mobile"
            class="navigation flex items-center flex-1 justify-end"
          >
            <li class="">
              <router-link
                to="/"
                class="link font-serif not-italic font-normal text-base lg:text-lg text-red-600"
                >Home</router-link
              >
            </li>
            <li class="">
              <router-link
                to="/audioVideo"
                class="link font-serif not-italic font-normal text-base lg:text-lg text-gray-500"
                >Audio &amp; Video</router-link
              >
            </li>
            <li class="">
              <router-link
      ...
      <div class="icon flex absolute items-center">
        <img
          ...
          v-show="mobile"
          class="img w-8"
          src="https://img.icons8.com/material/50/000000/menu--v1.png"
        />
      </div>
      <transition name="mobile-nav" class="">
        <ul
          v-show="mobileNav"
          class="dropdown-nav flex flex-col gap-y-4 fixed bg-red-600 z-50 w-screen"
        >
          ...
          <li class="">
            <router-link
              to="/"
              class="link font-serif not-italic text-base md:text-lg lg:text-xl text-white ml-3 mt-6 md:mt-8 lg:mt-10"
              >Home</router-link
            >
          </li>
          <li class="">
