  ...
  <div class="features">
    <div class="features-content p-6 sm:p-8 lg:p-16 xl:p-20">
      <div class="features-head">
        <h2
          class="text-white text-xl lg:text-2xl xl:text-3xl font-semibold mb-1 font-serif"
        >
          Featured Articles
        </h2>
        <div class="line"></div>
      ...
      <!-- <div class="featuredimages flex flex-col lg:flex-row mt-8 lg:mt-12 gap-y-4 lg:gap-x-20">
                    ...
                    :paragraph="featuredArticle.paragraph" 
                    />
            </div> -->
      ...
      <div class="mt-8 flex flex-col lg:flex-row lg:gap-x-32 xl:gap-x-52">
        <div class="jo flex flex-col lg:flex-row lg:gap-x-2">
          ...
          <!-- <div>
            ...
            <p class="text-base font-normal font-serif">
        ...
        <div>
          <h1 class="text-xl xl:text-2xl font-white font-serif text-white mb-4">
            See recently added videos, audio, articles, and news.
          </h1>
          <button class="text-white bg-red-700 font-serif">
            See What's New
          </button>
          <!-- <h5 class="text-white">{{ hello }}</h5> -->
        </div>
      </div>
    </div>
  </div>
